...
if args.isdata:
       Modules = [countHistogramsModule(),jmeCorrections_ak4_2018_Data(),jetmetUncertainties2018_Data(),WWGfakelepton_Module()]
else:
       if args.year=='2016':
       ...
       if args.year=='2018':
          Modules = [countHistogramsModule(),jmeCorrections_ak4_2018_MC(),jetmetUncertainties2018_MC(),btagSF_2018(),WWGfakelepton_Module(),puWeight_2018()]
