...
if args.isdata:
       Modules = [countHistogramsModule(),jmeCorrections_ak4_2018_Data(),jetmetUncertainties2018_Data(),WWGfakephoton_Module()]
else:
       if args.year=='2016':
          Modules = [countHistogramsModule(),WWGfakephoton_Module(),puWeight_2016(),PrefCorr_2016()]
       if args.year=='2017':
          Modules = [countHistogramsModule(),WWGfakephoton_Module(),puWeight_2017(),PrefCorr_2017()]
       if args.year=='2018':
          Modules = [countHistogramsModule(),jmeCorrections_ak4_2018_MC(),jetmetUncertainties2018_MC(),btagSF_2018(),WWGfakephoton_Module(),puWeight_2018()]
