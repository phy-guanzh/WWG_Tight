...
if args.isdata:
       Modules = [countHistogramsModule(),jmeCorrections_ak4_2018_Data(),WWGfakephoton_Module()]
else:
       if args.year=='2016':
       ...
       if args.year=='2018':
          Modules = [countHistogramsModule(),jmeCorrections_ak4_2018_MC(),btagSF_2018(),WWGfakephoton_Module(),puWeight_2018()]
