...
config.General.requestName = 'ZGJ_2018'
...
config.JobType.scriptArgs = ['kind=MC','mode=crab','year=2018','which_data=MC']
config.JobType.sendPythonFolder  = True

config.section_("Data")
config.Data.inputDataset = '/ZGToLLG_01J_LoosePtlPtg_5f_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_102X_upgrade2018_realistic_v21-v1/NANOAODSIM'
...
config.Data.outputDatasetTag = 'ZGJ_2018'
